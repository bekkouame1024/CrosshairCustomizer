...
dependencies {
    ...
    fapi("fabric-lifecycle-events-v1", "fabric-resource-loader-v0", "fabric-content-registries-v0", "fabric-screen-api-v1", "fabric-key-binding-api-v1")
}
...
loom {
    ...
    accessWidenerPath = rootProject.file("src/main/resources/crosshaircustomizer.accesswidener")
